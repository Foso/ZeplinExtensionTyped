...
function layer(context, layer) {
    ...
    switch (layer.type) {
        case "text": {
            ...
            return new CodeObject(text, "kotlin");
        }
        case "shape": {
...
function handleShape(project, layer) {
...
function printGradient(gradient) {
    var code11 = "Gradient\n";
    if (gradient != null) {
...
function printColorStop(colorStop) {
...
function textStyles(project) {
    ...
    return new CodeObject(names.join(""), "kotlin");
}
...
function colors(context) {
    ...
    code2 += colorsCode;
    return new CodeObject(code2, "kotlin");
}
...
function exportColors(context) {
    ...
    code2 += colorsCode;
    return new CodeExportObject(code2, "xml", "test2.kt");
}
